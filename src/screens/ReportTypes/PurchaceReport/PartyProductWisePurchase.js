...
const PartyProductWisePurchase = ({navigation}) => {
useLayoutEffect(()=>{
...
const [finalSearchCustomer, setfinalSearchCustomer] = useState('')
  ...
  return (
    <SafeAreaView>
    <View style={styles.PartyProductWisePurchaseTop}>
      <View style={styles.PartyProductWisePurchaseTopBtn}>
      <Button 
      title='Create PDF'
      containerStyle={{
        width:130,
      ...
      <View style={styles.PartyProductWisePurchaseTopTexts}>
        <View>
...
export default PartyProductWisePurchase

const styles = StyleSheet.create({
  PartyProductWisePurchaseTopBtn:{
    flexDirection:'row',
    width:'80%',
    marginLeft:'auto',
    marginRight:'auto',
  ...
  PartyProductWisePurchaseTopTexts:{
    flexDirection:'row',
    width:'70%',
    marginLeft:'auto',
    marginRight:'auto',
