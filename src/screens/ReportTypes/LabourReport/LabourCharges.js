...
import LabourChargesView from '../../../common/LabourChargesView'
...
const LabourCharges = ({navigation}) => {
useLayoutEffect(()=>{
...
const [finalSearchCustomer, setfinalSearchCustomer] = useState('')
  ...
  return (
    <SafeAreaView>
    <View style={styles.LabourChargesTop}>
      <View style={styles.LabourChargesTopBtn}>
      <Button 
      title='Create PDF'
      containerStyle={{
        width:130,
      ...
      <View style={styles.LabourChargesTopTexts}>
        <View style={{width:'10%'}}>
          <Text style={{color:colors.black}}>S.No</Text>
        </View>
        <View style={{width:'22%'}}>
          <Text style={{color:colors.black}}>Dispatch Date</Text>
        </View>
        <View style={{width:'17%'}}>
        ...
        <View style={{width:'15%'}}>
          <Text style={{color:colors.black}}>Labour Bag</Text>
        </View>

        <View style={{width:'20%'}}>
          <Text style={{color:colors.black}}>Labour Total</Text>
        </View>
...
/>
 ...
 <View style={styles.centered_viewInside}>
   <CalenderInput placeholder={'Date Filter'} extraStyles={{borderWidth:0}}
